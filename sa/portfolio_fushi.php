<?php include_once('includes/portfolio_header.php'); ?>
	...
	<div class="wrapper">
		<div class="main">
			...
			<section class="fullimage" style="background-image: url('/images/projects/portfolio/fushi2.png');">
			...
			<section class="fullimage" style="background-image: url('/images/projects/portfolio/fushi.png');">
				<div class="just_pattern" style="opacity:.3;"></div>
				<div class="just_pattern11"></div>
